...
class MagNavDataset(Dataset):
    ...
    def __init__(self, df, seq_length, split):
        ...
        self.features   = df.drop(columns=['TOPO','LINE','IGRFMAG1']).columns.to_list()
...
class CNN(torch.nn.Module):
    ...
    def __init__(self,seq_length):
        ...
        self.architecture = torch.nn.Sequential(
            ...
            torch.nn.Conv1d(in_channels  = 12,
                            out_channels = 64,
                            kernel_size  = 3,
                            stride       = 1,
                            padding      = 0,
...
if __name__ == "__main__":
    ...
    df6 = pd.read_hdf('./data/interim/dataset.h5', key=f'Flt1006')
    df7 = pd.read_hdf('./data/interim/dataset.h5', key=f'Flt1007')
