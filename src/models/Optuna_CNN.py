...
def objective(trial):
    ...
    num_filters     = [int(trial.suggest_discrete_uniform(
                      f"num_filter_{i}",16,128,16)) for i in range(num_conv_layers)]  # Number of filters for the conv layers
...
if __name__ == "__main__":
    ...
    batch_size_val = 1000                                                             # batch size for validation
    ...
    df2 = pd.read_hdf('./data/interim/Chall_dataset.h5', key=f'Flt1002')              # Import flight 1002
    df3 = pd.read_hdf('./data/interim/Chall_dataset.h5', key=f'Flt1003')              # Import flight 1003
    df4 = pd.read_hdf('./data/interim/Chall_dataset.h5', key=f'Flt1004')              # Import flight 1004
    df6 = pd.read_hdf('./data/interim/Chall_dataset.h5', key=f'Flt1006')              # Import flight 1006
    df7 = pd.read_hdf('./data/interim/Chall_dataset.h5', key=f'Flt1007')              # Import flight 1007
